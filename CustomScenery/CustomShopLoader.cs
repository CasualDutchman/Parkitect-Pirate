			...
			try
			{
				...
				using (WWW www = new WWW("file://" + Path + dsc + "assetbundle" + dsc + "shop"))
				{
					...
					foreach(KeyValuePair<string,object> pair in dict)
					{
                        ...
                        if(option.ContainsKey("displayname"))
                        {
                            new NameDecorator(pair.Key, (string)option["displayname"]).Decorate(asset, option, bundle);
                        }
                        else
                        {
                        ...
                        (new RecolorableDecorator(true)).Decorate(asset, option, bundle);
